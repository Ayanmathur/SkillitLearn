# 🎓 SkillItLearn — Full Curriculum Catalog

This document provides the complete hierarchical catalog of all **Careers**, **Learning Paths**, **Skills**, **Tracks**, and **Steps** across the platform.

---

## 1. Career: Agriculture & Agribusiness
**Slug**: `agriculture-agribusiness`  
**Description**: Grow, manage, and market agricultural products.  

### 1.1 Learning Path: Modern Farm Management
- **Path Slug**: `modern-farm-management`  
- **Description**: Run an efficient, productive farming operation.  

#### ⚡ Skill 1: Soil & Crop Management
- **Skill Slug**: `soil-and-crop-management`  
- **Description**: Understanding soil health and crop cycles.  
...
- **Description**: Efficient water use for crop production.  
...
- **Description**: Safe, effective use of common farm machinery.  
...
- **Description**: Pricing and selling agricultural products profitably.  
...
## 2. Career: Architecture & Construction
**Slug**: `architecture-construction`  
**Description**: Design and build the structures people live and work in.  

### 2.1 Learning Path: Architectural Design Foundations
- **Path Slug**: `architectural-design-foundations`  
- **Description**: Core skills for designing buildings and spaces.  

#### ⚡ Skill 1: Architectural Drafting
- **Skill Slug**: `architectural-drafting`  
- **Description**: Producing accurate plans, elevations, and sections.  
...
- **Description**: Drawing and modeling in AutoCAD or similar tools.  
...
- **Description**: Designing within legal and safety requirements.  
...
- **Description**: How buildings are actually assembled.  
...
- **Description**: Presenting designs with renders and walkthroughs.  
...
#### ⚡ Skill 1: Construction Planning & Scheduling
- **Skill Slug**: `construction-planning-and-scheduling`  
- **Description**: Sequencing work and tracking timelines.  
...
- **Description**: Budgeting materials, labor, and contingencies.  
...
- **Description**: Keeping job sites compliant and accident-free.  
...
- **Description**: Managing subcontractors, suppliers, and inspections.  
...
## 3. Career: Automotive Technology
**Slug**: `automotive-technology`  
**Description**: Diagnose, repair, and maintain vehicles.  

### 3.1 Learning Path: Automotive Repair Foundations
- **Path Slug**: `automotive-repair-foundations`  
- **Description**: Core skills for diagnosing and repairing modern vehicles.  

#### ⚡ Skill 1: Automotive Safety & Tools
- **Skill Slug**: `automotive-safety-and-tools`  
- **Description**: Safe use of tools and shop equipment.  
...
- **Description**: How combustion engines work and fail.  
...
- **Description**: Diagnosing vehicle electrical and sensor issues.  
...
- **Description**: Common repair procedures for brakes and suspension.  
...
- **Description**: Using OBD scanners to identify faults.  
...
### 4.1 Learning Path: Aviation Ground Operations
- **Path Slug**: `aviation-ground-operations`  
- **Description**: Support safe and efficient airport and flight operations.  

#### ⚡ Skill 1: Aviation Safety Fundamentals
- **Skill Slug**: `aviation-safety-fundamentals`  
- **Description**: Core safety standards in aviation environments.  
...
- **Description**: Ramp, baggage, and turnaround processes.  
...
- **Description**: Understanding key regulatory requirements.  
...
- **Description**: Coordinating schedules across ground and flight crews.  
...
## 5. Career: Cloud & DevOps Infrastructure
**Slug**: `cloud-devops-infrastructure`  
**Description**: Design and operate the cloud infrastructure that modern software runs on.  

### 5.1 Learning Path: Cloud Architecture
- **Path Slug**: `cloud-architecture`  
- **Description**: Design scalable, resilient systems on cloud platforms.  

#### ⚡ Skill 1: Cloud Computing Fundamentals
- **Skill Slug**: `cloud-computing-fundamentals`  
- **Description**: Compute, storage, networking across AWS/Azure/GCP.  
...
- **Description**: Terraform for repeatable infrastructure provisioning.  
...
- **Description**: IAM, network security groups, and encryption in the cloud.  
...
- **Description**: Load balancing, auto-scaling, and failover design.  
...
- **Description**: Right-sizing resources and managing cloud spend.  
...
- **Description**: Structured review for a major cloud certification exam.  
...
- **Description**: Keep large-scale systems fast, available, and observable.  

#### ⚡ Skill 1: Systems & Networking
- **Skill Slug**: `systems-and-networking`  
- **Description**: Deeper OS and network internals for reliability work.  
...
- **Description**: Metrics, logs, and traces for understanding system health.  
...
- **Description**: On-call practices, postmortems, and blameless review.  
...
- **Description**: Reducing toil through automation.  
...
- **Description**: Forecasting load and planning infrastructure ahead of demand.  
...
## 6. Career: Culinary Arts & Hospitality
**Slug**: `culinary-arts-hospitality`  
**Description**: Skills for food, beverage, and guest-facing hospitality careers.  

### 6.1 Learning Path: Professional Cooking Foundations
- **Path Slug**: `professional-cooking-foundations`  
- **Description**: Core kitchen skills used in professional cooking.  

#### ⚡ Skill 1: Kitchen Safety & Sanitation
- **Skill Slug**: `kitchen-safety-and-sanitation`  
- **Description**: Food safety standards and safe kitchen practices.  
...
- **Description**: Precise, efficient, and safe cutting techniques.  
...
- **Description**: Sauteing, braising, roasting, and other core methods.  
...
- **Description**: Pricing dishes profitably.  
...
- **Description**: Making food look as good as it tastes.  
...
- **Description**: Deliver excellent guest experiences in hotels, restaurants, and events.  

#### ⚡ Skill 1: Customer Service Excellence
- **Skill Slug**: `customer-service-excellence`  
- **Description**: Creating positive guest experiences consistently.  
...
- **Description**: Managing bookings and guest check-in/out.  
...
- **Description**: Turning service issues into positive outcomes.  
...
- **Description**: Coordinating logistics for guest events.  
...
## 7. Career: Cybersecurity
**Slug**: `cybersecurity`  
**Description**: Protect systems, networks, and data from attackers.  

### 7.1 Learning Path: Security Analyst
- **Path Slug**: `security-analyst`  
- **Description**: Monitor, detect, and respond to security threats.  

#### ⚡ Skill 1: Networking Fundamentals
- **Skill Slug**: `networking-fundamentals`  
- **Description**: TCP/IP, DNS, firewalls, and network topology.  
...
- **Description**: CIA triad, threat models, common attack types.  
...
- **Description**: Detecting anomalies using security monitoring tools.  
...
- **Description**: Containing, investigating, and recovering from incidents.  
...
- **Description**: Frameworks like ISO 27001, SOC 2, and audit readiness.  
...
- **Description**: Find and responsibly report vulnerabilities before attackers do.  

#### ⚡ Skill 1: Linux for Security
- **Skill Slug**: `linux-for-security`  
- **Description**: Command line fluency for security tooling.  
...
- **Description**: OWASP Top 10 and common web vulnerabilities.  
...
- **Description**: Scanning, enumeration, and exploitation basics.  
...
- **Description**: Using scanners and interpreting results.  
...
- **Description**: Communicating findings clearly and ethically.  
...
- **Description**: Turn raw data into decisions using statistics and visualization.  

#### ⚡ Skill 1: Excel for Analysis
- **Skill Slug**: `excel-for-analysis`  
- **Description**: Pivot tables, formulas, and data cleaning in spreadsheets.  
...
- **Description**: Building dashboards with Tableau or Power BI.  
...
- **Description**: Build, train, and deploy models that make predictions.  

#### ⚡ Skill 1: Python Programming
- **Skill Slug**: `python-programming`  
- **Description**: Core language skills for data and ML work.  
...
- **Description**: Mathematical foundations behind ML algorithms.  
...
- **Description**: Classification, regression, clustering with scikit-learn.  
...
- **Description**: Neural networks, backpropagation, PyTorch/TensorFlow basics.  
...
- **Description**: Cross-validation, metrics, hyperparameter search.  
...
- **Description**: Serving models via APIs and monitoring in production.  
...
- **Description**: Build the pipelines that move and prepare data at scale.  

#### ⚡ Skill 1: SQL & Data Warehousing
- **Skill Slug**: `sql-and-data-warehousing`  
- **Description**: Star schemas, warehouses, and query optimization.  
...
- **Description**: Extracting, transforming, and loading data reliably.  
...
- **Description**: Scripting pipelines and working with APIs/files.  
...
- **Description**: Spark and distributed processing basics.  
...
- **Description**: Scheduling and monitoring with Airflow.  
...
## 9. Career: Digital Marketing
**Slug**: `digital-marketing`  
**Description**: Plan, run, and measure campaigns that reach audiences and grow businesses online.  

### 9.1 Learning Path: Performance Marketing
- **Path Slug**: `performance-marketing`  
- **Description**: Run and optimize paid campaigns across major ad platforms.  

#### ⚡ Skill 1: Meta Ads Management
- **Skill Slug**: `meta-ads-management`  
- **Description**: Campaign structure, targeting, and optimization on Facebook & Instagram.  
...
- **Description**: Search, display, and shopping campaigns on Google Ads.  
...
- **Description**: Allocating spend and choosing bid strategies for ROI.  
...
- **Description**: Designing pages that convert paid traffic.  
...
- **Description**: Structuring experiments and reading results correctly.  
...
- **Description**: Create the writing, stories, and creative that build an audience.  

#### ⚡ Skill 1: Content Writing
- **Skill Slug**: `content-writing`  
- **Description**: Blog posts, web copy, and long-form content that reads well and ranks.  
...
- **Description**: Structuring narratives for video, reels, and ads.  
...
- **Description**: Keyword research, on-page SEO, and content structure for search.  
...
- **Description**: Platform-specific content planning and calendars.  
...
- **Description**: Defining and maintaining a consistent brand identity in content.  
...
- **Description**: Measure what's working and turn data into marketing decisions.  

#### ⚡ Skill 1: Google Analytics & Tag Manager
- **Skill Slug**: `google-analytics-and-tag-manager`  
- **Description**: Tracking setup, events, and funnels.  
...
- **Description**: Turning campaign data into stakeholder-ready reports.  
...
- **Description**: List building, automation, and email campaign performance.  
...
- **Description**: Benchmarking against competitors using ad libraries and SEO tools.  
...
## 10. Career: E-commerce Management
**Slug**: `e-commerce-management`  
**Description**: Run and grow an online store from setup to scale.  

### 10.1 Learning Path: E-commerce Operations
- **Path Slug**: `e-commerce-operations`  
- **Description**: Core skills for running a profitable online store.  

#### ⚡ Skill 1: Online Store Setup
- **Skill Slug**: `online-store-setup`  
- **Description**: Configuring a storefront on platforms like Shopify.  
...
- **Description**: Presenting products in ways that drive purchases.  
...
- **Description**: Handling checkout, shipping, and fulfillment smoothly.  
...
## 11. Career: Entrepreneurship & Small Business
**Slug**: `entrepreneurship-small-business`  
**Description**: Start, run, and grow a business from the ground up.  

### 11.1 Learning Path: Starting a Business
- **Path Slug**: `starting-a-business`  
- **Description**: Go from idea to a validated, launched business.  

#### ⚡ Skill 1: Idea Validation
- **Skill Slug**: `idea-validation`  
- **Description**: Testing demand before building.  
...
- **Description**: Mapping how the business creates and captures value.  
...
- **Description**: Pricing, margins, and cash flow for founders.  
...
- **Description**: Choosing a structure and meeting basic legal requirements.  
...
- **Description**: Getting the first customers and iterating fast.  
...
- **Description**: Manage operations and scale a running business.  

#### ⚡ Skill 1: Operations Management
- **Skill Slug**: `operations-management`  
- **Description**: Running day-to-day business processes efficiently.  
...
- **Description**: Bringing on early employees or contractors.  
...
- **Description**: Keeping customers coming back.  
...
- **Description**: Understanding equity, loans, and investor expectations.  
...
## 12. Career: Environmental Sustainability
...
### 12.1 Learning Path: Sustainability Management
- **Path Slug**: `sustainability-management`  
- **Description**: Help organizations reduce environmental impact.  

#### ⚡ Skill 1: Sustainability Fundamentals
- **Skill Slug**: `sustainability-fundamentals`  
- **Description**: Core concepts in environmental and corporate sustainability.  
...
- **Description**: Quantifying an organization's emissions.  
...
- **Description**: Reducing waste and resource use in operations.  
...
## 13. Career: Fashion & Apparel
**Slug**: `fashion-apparel`  
**Description**: Design and produce clothing and accessories.  

### 13.1 Learning Path: Fashion Design Foundations
- **Path Slug**: `fashion-design-foundations`  
- **Description**: Core skills for designing apparel from concept to sketch.  

#### ⚡ Skill 1: Fashion Sketching & Illustration
- **Skill Slug**: `fashion-sketching-and-illustration`  
- **Description**: Communicating design ideas visually.  
...
- **Description**: Understanding fabric properties and uses.  
...
- **Description**: Turning designs into wearable patterns.  
...
- **Description**: Sewing and assembling garments from patterns.  
...
## 14. Career: Finance & Accounting
**Slug**: `finance-accounting`  
**Description**: Manage money, from bookkeeping to financial strategy.  

### 14.1 Learning Path: Accounting Foundations
- **Path Slug**: `accounting-foundations`  
- **Description**: Core bookkeeping and financial reporting skills.  

#### ⚡ Skill 1: Bookkeeping Basics
- **Skill Slug**: `bookkeeping-basics`  
- **Description**: Recording transactions and maintaining ledgers.  
...
- **Description**: Reading and preparing income statements and balance sheets.  
...
- **Description**: Managing invoices, payments, and collections.  
...
- **Description**: Processing payroll and understanding deductions.  
...
- **Description**: Working in tools like QuickBooks or Xero.  
...
- **Description**: Analyze numbers to guide business and investment decisions.  

#### ⚡ Skill 1: Financial Modeling
- **Skill Slug**: `financial-modeling`  
- **Description**: Building spreadsheet models for forecasting.  
...
- **Description**: Estimating the worth of a company or asset.  
...
- **Description**: Planning and tracking against financial targets.  
...
- **Description**: Interpreting liquidity, profitability, and leverage ratios.  
...
## 15. Career: Fitness & Personal Training
**Slug**: `fitness-personal-training`  
**Description**: Help people build strength, health, and healthy habits.  

### 15.1 Learning Path: Personal Training Foundations
- **Path Slug**: `personal-training-foundations`  
- **Description**: Core skills for coaching one-on-one fitness clients.  

#### ⚡ Skill 1: Exercise Science Basics
- **Skill Slug**: `exercise-science-basics`  
- **Description**: Anatomy and physiology relevant to training.  
...
- **Description**: Building safe, effective workout programs.  
...
- **Description**: Evaluating fitness levels and setting realistic goals.  
...
- **Description**: Keeping clients engaged and progressing safely.  
...
## 16. Career: Game Development
**Slug**: `game-development`  
**Description**: Design and build interactive games across platforms.  

### 16.1 Learning Path: Game Design Foundations
- **Path Slug**: `game-design-foundations`  
- **Description**: Core skills for designing engaging game systems and experiences.  

#### ⚡ Skill 1: Game Design Principles
- **Skill Slug**: `game-design-principles`  
- **Description**: Mechanics, dynamics, and player experience fundamentals.  
...
- **Description**: Crafting spaces and challenges that guide players.  
...
- **Description**: Tuning difficulty, economy, and progression.  
...
- **Description**: Quickly testing mechanics before full production.  
...
- **Description**: Weaving story into interactive systems.  
...
- **Description**: Build the code that brings games to life.  

#### ⚡ Skill 1: Programming Fundamentals for Games
- **Skill Slug**: `programming-fundamentals-for-games`  
- **Description**: Core coding concepts applied to game logic.  
...
- **Description**: Building playable scenes in a modern game engine.  
...
- **Description**: Implementing realistic or stylized game physics.  
...
- **Description**: Keeping games running smoothly across devices.  
...
- **Description**: Fundamentals of connecting players online.  
...
- **Description**: Create the visual assets and animation that define a game's look.  

#### ⚡ Skill 1: 2D Game Art Fundamentals
- **Skill Slug**: `2d-game-art-fundamentals`  
- **Description**: Sprites, tiles, and stylized 2D visuals.  
...
- **Description**: Building game-ready 3D assets.  
...
- **Description**: Making 3D models look realistic or stylized.  
...
- **Description**: Bringing characters and worlds to life in motion.  
...
## 17. Career: Graphic Design & Visual Media
**Slug**: `graphic-design-visual-media`  
**Description**: Communicate visually across print, digital, and motion media.  

### 17.1 Learning Path: Graphic Design Foundations
- **Path Slug**: `graphic-design-foundations`  
- **Description**: Core visual design skills for branding and marketing materials.  

#### ⚡ Skill 1: Design Principles
- **Skill Slug**: `design-principles`  
- **Description**: Balance, contrast, hierarchy, and composition.  
...
- **Description**: Choosing and pairing type for impact and readability.  
...
- **Description**: Vector and raster design tools in practice.  
...
- **Description**: Designing cohesive visual identities.  
...
- **Description**: Tell stories through edited video and animated visuals.  

#### ⚡ Skill 1: Video Editing Fundamentals
- **Skill Slug**: `video-editing-fundamentals`  
- **Description**: Cutting, pacing, and structuring footage.  
...
- **Description**: Animated titles, transitions, and visual effects.  
...
- **Description**: Polishing the look and sound of a final cut.  
...
## 18. Career: Healthcare Support
**Slug**: `healthcare-support`  
**Description**: Skills for allied and support roles across healthcare settings.  

### 18.1 Learning Path: Medical Administration
- **Path Slug**: `medical-administration`  
- **Description**: Keep clinical and administrative operations running smoothly.  

#### ⚡ Skill 1: Medical Terminology
- **Skill Slug**: `medical-terminology`  
- **Description**: Common clinical vocabulary and abbreviations.  
...
- **Description**: Handling patient records accurately and confidentially.  
...
- **Description**: Understanding claims, codes, and insurance basics.  
...
- **Description**: Professional, empathetic front-desk interactions.  
...
- **Description**: Foundational skills for direct patient support roles.  

#### ⚡ Skill 1: Vital Signs & Basic Assessment
- **Skill Slug**: `vital-signs-and-basic-assessment`  
- **Description**: Measuring and recording basic patient indicators.  
...
- **Description**: Hygiene, sterilization, and safety protocols.  
...
- **Description**: Assisting patients safely and comfortably.  
...
- **Description**: First response until professional help arrives.  
...
## 19. Career: Human Resources
**Slug**: `human-resources`  
**Description**: Hire, develop, and support the people inside organizations.  

### 19.1 Learning Path: Talent Acquisition
- **Path Slug**: `talent-acquisition`  
- **Description**: Find and hire the right people for the right roles.  

#### ⚡ Skill 1: Sourcing & Recruiting
- **Skill Slug**: `sourcing-and-recruiting`  
- **Description**: Finding candidates across channels.  
...
- **Description**: Structured interviews that reduce bias.  
...
- **Description**: Positioning a company as a place people want to work.  
...
- **Description**: Closing candidates and setting them up to succeed.  
...
- **Description**: Support employees and keep HR operations running smoothly.  

#### ⚡ Skill 1: HR Policies & Compliance
- **Skill Slug**: `hr-policies-and-compliance`  
- **Description**: Employment law basics and policy design.  
...
- **Description**: Running reviews and feedback cycles.  
...
- **Description**: Structuring pay and benefits fairly.  
...
- **Description**: Measuring and improving workplace satisfaction.  
...
### 20.1 Learning Path: Insurance Sales & Underwriting Basics
- **Path Slug**: `insurance-sales-underwriting-basics`  
- **Description**: Core skills for selling and evaluating insurance policies.  

#### ⚡ Skill 1: Insurance Fundamentals
- **Skill Slug**: `insurance-fundamentals`  
- **Description**: Core concepts of risk, premiums, and coverage.  
...
- **Description**: How policies are evaluated and priced.  
...
- **Description**: How claims are filed, reviewed, and settled.  
...
- **Description**: Matching clients to appropriate coverage.  
...
## 21. Career: Interior Design
**Slug**: `interior-design`  
**Description**: Design functional, beautiful indoor spaces.  

### 21.1 Learning Path: Interior Design Foundations
- **Path Slug**: `interior-design-foundations`  
- **Description**: Core skills for designing residential and commercial interiors.  

#### ⚡ Skill 1: Space Planning
- **Skill Slug**: `space-planning`  
- **Description**: Arranging layouts for function and flow.  
...
- **Description**: Choosing finishes that suit a space's purpose and mood.  
...
- **Description**: Producing floor plans and renders digitally.  
...
- **Description**: Selecting and specifying furnishings within budget.  
...
- **Description**: Presenting design concepts persuasively to clients.  
...
## 22. Career: IT & Technical Support
**Slug**: `it-and-technical-support`  
**Description**: Keep people and their technology working, from hardware to help desk.  

### 22.1 Learning Path: Help Desk & IT Support Foundations
- **Path Slug**: `help-desk-and-it-support-foundations`  
- **Description**: Core skills for resolving everyday technology problems for users.  

#### ⚡ Skill 1: Computer Hardware Basics
- **Skill Slug**: `computer-hardware-basics`  
- **Description**: Understanding core components and common hardware issues.  
...
- **Description**: Diagnosing and fixing common Windows/Mac OS problems.  
...
- **Description**: Basic connectivity troubleshooting for end users.  
...
- **Description**: Managing support tickets and communicating clearly with users.  
...
- **Description**: Diagnosing and fixing issues on remote machines.  
...
## 23. Career: Journalism & Writing
**Slug**: `journalism-writing`  
**Description**: Research, report, and write for an audience.  

### 23.1 Learning Path: News Journalism
- **Path Slug**: `news-journalism`  
- **Description**: Report accurate, timely news stories.  

#### ⚡ Skill 1: News Writing Fundamentals
- **Skill Slug**: `news-writing-fundamentals`  
- **Description**: Structuring clear, fact-first news stories.  
...
- **Description**: Getting useful, quotable information from people.  
...
- **Description**: Confirming accuracy before publishing.  
...
- **Description**: Working within legal and ethical journalism standards.  
...
- **Description**: Write professionally across formats for varied clients.  

#### ⚡ Skill 1: Writing Craft & Editing
- **Skill Slug**: `writing-craft-and-editing`  
- **Description**: Producing clean, engaging prose across formats.  
...
- **Description**: Landing and managing freelance writing work.  
...
- **Description**: Writing content that also performs in search.  
...
- **Description**: Pricing, contracts, and managing freelance income.  
...
## 24. Career: Laboratory Science
**Slug**: `laboratory-science`  
**Description**: Conduct and support scientific testing and research in lab settings.  

### 24.1 Learning Path: Lab Technician Foundations
- **Path Slug**: `lab-technician-foundations`  
- **Description**: Core skills for working safely and accurately in a lab.  

#### ⚡ Skill 1: Lab Safety & Compliance
- **Skill Slug**: `lab-safety-and-compliance`  
- **Description**: Handling chemicals and equipment safely.  
...
- **Description**: Preparing and processing samples accurately.  
...
- **Description**: Using common lab instruments correctly.  
...
- **Description**: Accurately documenting experiments and results.  
...
- **Description**: Ensuring consistent, reliable lab results.  
...
## 25. Career: Legal Support
**Slug**: `legal-support`  
**Description**: Skills for paralegal and legal-adjacent support roles.  

### 25.1 Learning Path: Paralegal Foundations
- **Path Slug**: `paralegal-foundations`  
- **Description**: Core skills for supporting attorneys and legal teams.  

#### ⚡ Skill 1: Legal Terminology & Research
- **Skill Slug**: `legal-terminology-and-research`  
- **Description**: Understanding legal language and finding case law.  
...
- **Description**: Preparing contracts, briefs, and legal correspondence.  
...
- **Description**: Organizing files, deadlines, and case timelines.  
...
- **Description**: Professional responsibility in legal work.  
...
## 26. Career: Library & Information Science
**Slug**: `library-information-science`  
**Description**: Organize, manage, and provide access to information and knowledge.  

### 26.1 Learning Path: Library & Information Services
- **Path Slug**: `library-information-services`  
- **Description**: Core skills for managing collections and helping patrons find information.  

#### ⚡ Skill 1: Information Organization & Cataloging
- **Skill Slug**: `information-organization-and-cataloging`  
- **Description**: Classifying and organizing materials for retrieval.  
...
- **Description**: Helping patrons find accurate, relevant information.  
...
- **Description**: Managing e-resources and digital archives.  
...
- **Description**: Planning events and programs that serve the community.  
...
## 27. Career: Manufacturing & Quality
**Slug**: `manufacturing-quality`  
**Description**: Produce goods efficiently and to consistent quality standards.  

### 27.1 Learning Path: Manufacturing Operations
- **Path Slug**: `manufacturing-operations`  
- **Description**: Run efficient, safe production line operations.  

#### ⚡ Skill 1: Production Process Fundamentals
- **Skill Slug**: `production-process-fundamentals`  
- **Description**: How manufacturing workflows are structured.  
...
- **Description**: Reducing waste and improving efficiency.  
...
- **Description**: Safe operation of equipment and environments.  
...
- **Description**: Inspecting and maintaining product quality standards.  
...
## 28. Career: Mental Health Counseling
...
### 28.1 Learning Path: Clinical Counseling Foundations
- **Path Slug**: `clinical-counseling-foundations`  
- **Description**: Core clinical skills for supportive, ethical counseling practice.  

#### ⚡ Skill 1: Counseling Theories & Approaches
- **Skill Slug**: `counseling-theories-and-approaches`  
- **Description**: Major frameworks that guide counseling practice.  
...
- **Description**: Responding safely and sensitively to trauma and crisis.  
...
- **Description**: Running supportive group sessions effectively.  
...
- **Description**: Keeping accurate records within ethical and legal bounds.  
...
## 29. Career: Mobile App Development
**Slug**: `mobile-app-development`  
**Description**: Design and build native and cross-platform mobile applications.  

### 29.1 Learning Path: Cross-Platform Mobile Development
- **Path Slug**: `cross-platform-mobile-development`  
- **Description**: Build apps that run on both iOS and Android from one codebase.  

#### ⚡ Skill 1: Mobile UI Fundamentals
- **Skill Slug**: `mobile-ui-fundamentals`  
- **Description**: Designing touch-friendly interfaces for small screens.  
...
- **Description**: Building cross-platform apps with a shared codebase.  
...
- **Description**: Managing app state and screen navigation flows.  
...
- **Description**: Camera, location, and notifications on mobile devices.  
...
- **Description**: Packaging and publishing apps to app stores.  
...
## 30. Career: Music & Audio Production
**Slug**: `music-audio-production`  
**Description**: Create, record, and produce music and audio content.  

### 30.1 Learning Path: Music Production Foundations
- **Path Slug**: `music-production-foundations`  
- **Description**: Core skills for producing music in a modern studio.  

#### ⚡ Skill 1: Music Theory Basics
- **Skill Slug**: `music-theory-basics`  
- **Description**: Scales, chords, and rhythm fundamentals.  
...
- **Description**: Producing and arranging tracks in a digital audio workstation.  
...
- **Description**: Capturing clean, usable audio.  
...
- **Description**: Balancing levels, EQ, and effects into a finished mix.  
...
## 31. Career: Non-Profit & Social Work
**Slug**: `non-profit-social-work`  
**Description**: Support communities and causes through mission-driven work.  

### 31.1 Learning Path: Non-Profit Program Management
- **Path Slug**: `non-profit-program-management`  
- **Description**: Plan and run programs that deliver real community impact.  

#### ⚡ Skill 1: Program Design & Planning
- **Skill Slug**: `program-design-and-planning`  
- **Description**: Structuring programs around clear outcomes.  
...
- **Description**: Writing proposals that secure funding.  
...
- **Description**: Recruiting and managing volunteers effectively.  
...
- **Description**: Demonstrating and reporting program outcomes.  
...
- **Description**: Core skills for supporting individuals and families in need.  

#### ⚡ Skill 1: Case Management Basics
- **Skill Slug**: `case-management-basics`  
- **Description**: Coordinating support services for clients.  
...
- **Description**: Responding effectively to urgent client needs.  
...
- **Description**: Connecting clients to the right support services.  
...
- **Description**: Maintaining professional, ethical client relationships.  
...
## 32. Career: People Management & Leadership
**Slug**: `people-management-and-leadership`  
**Description**: Lead, coach, and get the best out of a team.  

### 32.1 Learning Path: People Management Foundations
- **Path Slug**: `people-management-foundations`  
- **Description**: Core skills for managing people effectively for the first time.  

#### ⚡ Skill 1: Leading Teams
- **Skill Slug**: `leading-teams`  
- **Description**: Setting direction and expectations for a team.  
...
- **Description**: Handing off work effectively and giving feedback that lands.  
...
- **Description**: Helping team members grow and improve over time.  
...
- **Description**: Communicating clearly up, down, and across an organization.  
...
## 33. Career: Photography
**Slug**: `photography`  
**Description**: Capture and edit compelling images professionally.  

### 33.1 Learning Path: Photography Foundations
- **Path Slug**: `photography-foundations`  
- **Description**: Core technical and creative photography skills.  

#### ⚡ Skill 1: Camera & Exposure Fundamentals
- **Skill Slug**: `camera-and-exposure-fundamentals`  
- **Description**: Aperture, shutter speed, ISO, and manual control.  
...
- **Description**: Framing shots and working with available or set lighting.  
...
- **Description**: Post-processing in Lightroom or similar tools.  
...
- **Description**: Curating and presenting work professionally.  
...
## 34. Career: Product Management
**Slug**: `product-management`  
**Description**: Define what gets built and why, aligning teams around user and business value.  

### 34.1 Learning Path: Core Product Management
- **Path Slug**: `core-product-management`  
- **Description**: The essential skills for owning a product roadmap.  

#### ⚡ Skill 1: Product Discovery
- **Skill Slug**: `product-discovery`  
- **Description**: Identifying real problems worth solving.  
...
- **Description**: Sequencing work using frameworks like RICE.  
...
- **Description**: Translating ideas into buildable specs.  
...
- **Description**: Defining and tracking product success metrics.  
...
- **Description**: Launching features and coordinating release plans.  
...
## 35. Career: Project Management
**Slug**: `project-management`  
**Description**: Plan, coordinate, and deliver projects on time and within scope.  

### 35.1 Learning Path: Project Management Foundations
- **Path Slug**: `project-management-foundations`  
- **Description**: Core skills for running structured, on-track projects.  

#### ⚡ Skill 1: Project Planning & Scope Definition
- **Skill Slug**: `project-planning-and-scope-definition`  
- **Description**: Defining what a project will and won't deliver.  
...
- **Description**: Running iterative, adaptive project workflows.  
...
- **Description**: Anticipating and handling problems before they derail a project.  
...
- **Skill Slug**: `stakeholder-communication`  
- **Description**: Keeping the right people informed at the right time.  
...
- **Description**: Using tools like Jira, Asana, or Trello to track work.  
...
## 36. Career: Psychology & Human Understanding
**Slug**: `psychology-human-understanding`  
...
### 36.1 Learning Path: Human Behavior Track
- **Path Slug**: `human-behavior-track`  
- **Description**: Build a foundation in how and why people behave the way they do.  

#### ⚡ Skill 1: Human Understanding & Empathy
- **Skill Slug**: `human-understanding-and-empathy`  
- **Description**: Recognizing and responding to others' emotional states.  
...
- **Description**: Reading context and social dynamics accurately before acting.  
...
- **Description**: Identifying brief, involuntary facial expressions and what they signal.  
...
- **Description**: Non-verbal cues in posture, gesture, and tone.  
...
- **Description**: How people actually make decisions, and where it goes wrong.  
...
- **Description**: Core interpersonal skills used in counseling, coaching, and support roles.  

#### ⚡ Skill 1: Active Listening
- **Skill Slug**: `active-listening`  
- **Description**: Listening techniques that make people feel genuinely heard.  
...
- **Description**: Foundational approaches used in supportive conversations.  
...
- **Description**: De-escalating and mediating interpersonal conflict.  
...
- **Description**: Professional boundaries and ethical considerations in helping roles.  
...
## 37. Career: Public Relations & Communications
**Slug**: `public-relations-communications`  
**Description**: Shape and protect how organizations are perceived publicly.  

### 37.1 Learning Path: PR & Media Relations
- **Path Slug**: `pr-media-relations`  
- **Description**: Build relationships with media and manage public messaging.  

#### ⚡ Skill 1: Press Release Writing
- **Skill Slug**: `press-release-writing`  
- **Description**: Writing announcements that earn media coverage.  
...
- **Description**: Building relationships with journalists and outlets.  
...
- **Description**: Managing messaging during reputational challenges.  
...
- **Description**: Crafting a consistent public narrative for a brand.  
...
## 38. Career: Public Safety & Emergency Services
**Slug**: `public-safety-emergency-services`  
**Description**: Protect and respond to communities in emergencies.  

### 38.1 Learning Path: Emergency Response Foundations
- **Path Slug**: `emergency-response-foundations`  
- **Description**: Core skills for first-response and emergency situations.  

#### ⚡ Skill 1: First Aid & CPR
- **Skill Slug**: `first-aid-and-cpr`  
- **Description**: Life-saving basic emergency medical response.  
...
- **Description**: Quickly and safely evaluating an emergency situation.  
...
- **Description**: Clear radio and verbal communication during emergencies.  
...
- **Description**: Legal and procedural fundamentals for responders.  
...
- **Description**: Planning for and mitigating large-scale emergencies.  
...
## 39. Career: Real Estate
**Slug**: `real-estate`  
**Description**: Help people buy, sell, lease, and invest in property.  

### 39.1 Learning Path: Real Estate Sales
- **Path Slug**: `real-estate-sales`  
- **Description**: Represent buyers and sellers through property transactions.  

#### ⚡ Skill 1: Real Estate Fundamentals & Law Basics
- **Skill Slug**: `real-estate-fundamentals-and-law-basics`  
- **Description**: Core concepts and legal basics of property transactions.  
...
- **Description**: Estimating a property's fair market value.  
...
- **Description**: Finding and nurturing buyer/seller relationships.  
...
- **Description**: Navigating offers through to a completed sale.  
...
- **Description**: Manage rental properties on behalf of owners.  

#### ⚡ Skill 1: Tenant Screening & Leasing
- **Skill Slug**: `tenant-screening-and-leasing`  
- **Description**: Finding and vetting reliable tenants.  
...
- **Description**: Keeping properties in good condition efficiently.  
...
- **Description**: Managing income and expenses for a property.  
...
- **Description**: Staying compliant with rental regulations.  
...
## 40. Career: Retail Management
**Slug**: `retail-management`  
**Description**: Run stores and retail teams that deliver great customer experiences.  

### 40.1 Learning Path: Retail Operations
- **Path Slug**: `retail-operations`  
- **Description**: Manage the day-to-day operations of a retail store.  

#### ⚡ Skill 1: Store Operations Fundamentals
- **Skill Slug**: `store-operations-fundamentals`  
- **Description**: Opening/closing procedures, cash handling, and workflows.  
...
- **Description**: Stocking, displaying, and tracking products effectively.  
...
- **Description**: Creating positive in-store shopping experiences.  
...
- **Description**: Scheduling, training, and motivating store staff.  
...
- **Description**: Drive sales through effective merchandising and customer engagement.  

#### ⚡ Skill 1: Visual Merchandising
- **Skill Slug**: `visual-merchandising`  
- **Description**: Designing displays that attract and convert shoppers.  
...
- **Description**: Upselling and closing sales on the floor.  
...
- **Description**: Reading sales data to guide store decisions.  
...
- **Description**: Reducing shrinkage and theft in retail environments.  
...
## 41. Career: Sales & Business Development
**Slug**: `sales-business-development`  
**Description**: Win and grow customer relationships that drive revenue.  

### 41.1 Learning Path: B2B Sales
- **Path Slug**: `b2b-sales`  
- **Description**: Sell complex products and services to businesses.  

#### ⚡ Skill 1: Prospecting & Lead Generation
- **Skill Slug**: `prospecting-and-lead-generation`  
...
- **Description**: Discovering needs and positioning solutions.  
...
- **Description**: Navigating pushback and closing deals fairly.  
...
- **Description**: Tracking deals and forecasting accurately.  
...
- **Description**: Pitching persuasively to decision-makers.  
...
#### ⚡ Skill 1: Customer Onboarding
- **Skill Slug**: `customer-onboarding`  
- **Description**: Setting new accounts up for long-term success.  
...
- **Description**: Building trust and communicating proactively.  
...
- **Description**: Growing account value while protecting retention.  
...
- **Description**: Tracking usage and risk signals to act early.  
...
## 42. Career: Skilled Trades
**Slug**: `skilled-trades`  
**Description**: Hands-on technical trades that keep the physical world running.  

### 42.1 Learning Path: Residential Electrical Basics
- **Path Slug**: `residential-electrical-basics`  
- **Description**: Foundational knowledge for residential electrical work.  

#### ⚡ Skill 1: Electrical Safety
- **Skill Slug**: `electrical-safety`  
- **Description**: Working safely around live circuits and equipment.  
...
- **Description**: Understanding voltage, current, and basic circuit design.  
...
- **Description**: Common residential wiring tasks and standards.  
...
- **Description**: Interpreting and applying local electrical codes.  
...
- **Description**: Core skills for residential plumbing work.  

#### ⚡ Skill 1: Plumbing Safety & Tools
- **Skill Slug**: `plumbing-safety-and-tools`  
- **Description**: Safe use of common plumbing tools and equipment.  
...
- **Description**: Understanding supply and drain systems.  
...
- **Description**: Installing and fixing sinks, toilets, and faucets.  
...
- **Description**: Finding and resolving common plumbing issues.  
...
- **Description**: Build the interfaces users interact with directly, in the browser.  

#### ⚡ Skill 1: HTML & CSS Fundamentals
- **Skill Slug**: `html-and-css-fundamentals`  
...
- **Description**: Core language features, DOM manipulation, async programming.  
...
- **Description**: Layouts that work across devices and are usable by everyone.  
...
- **Description**: Bundlers, lazy loading, Lighthouse audits, build pipelines.  
...
- **Description**: Unit and component testing with Jest/React Testing Library.  
...
- **Description**: Build the servers, APIs, and data layers that power applications.  

#### ⚡ Skill 1: Node.js & Express
- **Skill Slug**: `node-js-and-express`  
- **Description**: Server-side JavaScript and building HTTP APIs.  
...
- **Description**: Schema design, queries, joins, indexing.  
...
- **Description**: Sessions, JWTs, OAuth, role-based access control.  
...
- **Description**: Unit, integration, and API contract testing.  
...
- **Description**: Redis, background jobs, and message queues for scale.  
...
- **Path Slug**: `devops`  
- **Description**: Automate, deploy, and keep systems running reliably.  

#### ⚡ Skill 1: Linux & Command Line
- **Skill Slug**: `linux-and-command-line`  
- **Description**: Filesystem, permissions, shell scripting basics.  
...
- **Description**: Branching, merging, pull requests, collaboration workflows.  
...
- **Description**: Containerizing applications and managing images.  
...
- **Description**: Core services on AWS/Azure/GCP — compute, storage, networking.  
...
- **Description**: Logging, alerting, and on-call basics.  
...
- **Description**: Combine frontend and backend skills to ship complete applications end to end.  

#### ⚡ Skill 1: System Design Basics
- **Skill Slug**: `system-design-basics`  
- **Description**: Trade-offs in architecture, scaling, and data flow.  
...
- **Description**: API integration, state management, error handling across the stack.  
...
- **Description**: Shipping a full application to production.  
...
- **Description**: Build and deploy a complete application applying all prior skills.  
...
## 44. Career: Software Quality Assurance
**Slug**: `software-quality-assurance`  
**Description**: Make sure software works the way it's supposed to before it reaches users.  

### 44.1 Learning Path: QA & Software Testing Foundations
- **Path Slug**: `qa-and-software-testing-foundations`  
- **Description**: Core skills for finding and preventing software defects.  

#### ⚡ Skill 1: Manual Testing Fundamentals
- **Skill Slug**: `manual-testing-fundamentals`  
- **Description**: Designing and executing test cases by hand.  
...
- **Description**: Writing test cases that actually catch real bugs.  
...
- **Description**: Writing scripts that test software automatically.  
...
- **Description**: Documenting defects clearly enough for developers to fix them.  
...
## 45. Career: Supply Chain & Logistics
**Slug**: `supply-chain-logistics`  
**Description**: Move goods efficiently from source to customer.  

### 45.1 Learning Path: Logistics Operations
- **Path Slug**: `logistics-operations`  
- **Description**: Coordinate the movement and storage of goods.  

#### ⚡ Skill 1: Inventory Management
- **Skill Slug**: `inventory-management`  
- **Description**: Tracking stock levels and avoiding shortages or excess.  
...
- **Description**: Efficient receiving, storage, and fulfillment processes.  
...
- **Description**: Choosing and coordinating shipping methods.  
...
- **Description**: Using systems to monitor shipments and inventory.  
...
- **Description**: Forecast demand and plan the end-to-end supply chain.  

#### ⚡ Skill 1: Demand Forecasting
- **Skill Slug**: `demand-forecasting`  
- **Description**: Predicting future demand from historical data.  
...
- **Description**: Sourcing suppliers and managing purchasing.  
...
- **Description**: Building reliable, cost-effective supplier partnerships.  
...
- **Description**: Identifying and mitigating disruption risks.  
...
## 46. Career: Teaching & Education
**Slug**: `teaching-education`  
**Description**: Design learning experiences and help others grow.  

### 46.1 Learning Path: Classroom Teaching Foundations
- **Path Slug**: `classroom-teaching-foundations`  
- **Description**: Core skills for planning and running effective lessons.  

#### ⚡ Skill 1: Lesson Planning
- **Skill Slug**: `lesson-planning`  
- **Description**: Structuring lessons around clear learning objectives.  
...
- **Description**: Creating a productive, respectful learning environment.  
...
- **Description**: Adapting teaching to different learner needs.  
...
- **Description**: Measuring learning and giving useful feedback.  
...
- **Description**: Using digital tools to support teaching.  
...
- **Description**: Design structured learning content and courses.  

#### ⚡ Skill 1: Learning Objectives & Curriculum Design
- **Skill Slug**: `learning-objectives-and-curriculum-design`  
- **Description**: Structuring what learners should know and do.  
...
- **Description**: How adults learn differently than children.  
...
- **Description**: Building interactive courses with common e-learning tools.  
...
- **Description**: Measuring whether training actually worked.  
...
## 47. Career: Technical Writing
**Slug**: `technical-writing`  
**Description**: Turn complex, technical information into clear documentation people can use.  

### 47.1 Learning Path: Technical Writing Foundations
- **Path Slug**: `technical-writing-foundations`  
- **Description**: Core skills for writing documentation that people actually understand.  

#### ⚡ Skill 1: Documentation Fundamentals
- **Skill Slug**: `documentation-fundamentals`  
- **Description**: Structuring docs so readers find what they need fast.  
...
- **Description**: Writing docs that help developers integrate correctly.  
...
- **Description**: Keeping writing consistent, clear, and free of jargon overload.  
...
- **Description**: Working in docs-as-code and publishing toolchains.  
...
## 48. Career: Telecommunications
**Slug**: `telecommunications`  
**Description**: Build and maintain the networks that connect people and devices.  

### 48.1 Learning Path: Telecom Network Technician
- **Path Slug**: `telecom-network-technician`  
- **Description**: Install and maintain telecommunications infrastructure.  

#### ⚡ Skill 1: Telecom Fundamentals
- **Skill Slug**: `telecom-fundamentals`  
- **Description**: How voice, data, and signal networks operate.  
...
- **Description**: Installing and terminating network cabling correctly.  
...
- **Description**: Diagnosing and resolving connectivity issues.  
...
- **Description**: Fundamentals of cellular and wireless infrastructure.  
...
## 49. Career: Translation & Language Services
**Slug**: `translation-language-services`  
**Description**: Bridge communication across languages professionally.  

### 49.1 Learning Path: Professional Translation
- **Path Slug**: `professional-translation`  
- **Description**: Translate written content accurately and fluently.  

#### ⚡ Skill 1: Translation Fundamentals
- **Skill Slug**: `translation-fundamentals`  
- **Description**: Accuracy, tone, and fidelity across languages.  
...
- **Description**: Using computer-assisted translation software.  
...
- **Description**: Building glossaries for legal, medical, or technical domains.  
...
- **Description**: Catching errors before delivery.  
...
## 50. Career: Urban Planning
**Slug**: `urban-planning`  
**Description**: Shape how cities and communities grow and function.  

### 50.1 Learning Path: Urban & Community Planning Foundations
- **Path Slug**: `urban-community-planning-foundations`  
- **Description**: Core skills for planning land use and community development.  

#### ⚡ Skill 1: Land Use & Zoning Fundamentals
- **Skill Slug**: `land-use-and-zoning-fundamentals`  
- **Description**: How land is designated and regulated for use.  
...
- **Description**: Mapping and spatial analysis for planning decisions.  
...
- **Description**: Gathering and incorporating public input in planning.  
...
- **Description**: Designing communities with sustainability in mind.  
...
## 51. Career: UX/UI Design
**Slug**: `ux-ui-design`  
**Description**: Design digital products that are usable, useful, and delightful.  

### 51.1 Learning Path: UX Research & Strategy
- **Path Slug**: `ux-research-strategy`  
- **Description**: Understand users and shape product direction around real needs.  

#### ⚡ Skill 1: User Research Methods
- **Skill Slug**: `user-research-methods`  
...
- **Description**: Translating research into actionable user models.  
...
- **Description**: Structuring content and navigation logically.  
...
- **Description**: Running tests and turning findings into design changes.  
...
- **Description**: Clear, concise microcopy for interfaces.  
...
- **Description**: Craft visual interfaces and interactive prototypes.  

#### ⚡ Skill 1: Visual Design Fundamentals
- **Skill Slug**: `visual-design-fundamentals`  
- **Description**: Layout, color, typography, and hierarchy.  
...
- **Description**: Building and maintaining reusable component libraries.  
...
- **Description**: Designing inclusively for all users.  
...
- **Description**: Specs, redlines, and collaborating with engineers.  
...
## 52. Career: Veterinary & Animal Care
**Slug**: `veterinary-animal-care`  
**Description**: Support the health and wellbeing of animals.  

### 52.1 Learning Path: Veterinary Assistant Foundations
- **Path Slug**: `veterinary-assistant-foundations`  
- **Description**: Core skills for supporting veterinary clinical work.  

#### ⚡ Skill 1: Animal Handling & Restraint
- **Skill Slug**: `animal-handling-and-restraint`  
- **Description**: Safely handling animals during exams and procedures.  
...
- **Description**: Common clinical language used in animal care.  
...
- **Description**: Infection control and safe clinic practices.  
...
- **Description**: Communicating clearly and compassionately with pet owners.  
