      ...
      <header className="sticky top-0 z-50 bg-[#1a1a2e] shadow-lg">
        <div className="container-page flex items-center justify-between h-14">
          ...
          <nav className="flex items-center gap-2 text-xs text-white/60">
            <Link href="/admin/careers" className="hover:text-white">Careers</Link>
            <span>/</span>
            <Link href={`/admin/careers/${path.career.id}`} className="hover:text-white">{path.career.name}</Link>
            <span>/</span>
