    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="bg-green-50 dark:bg-[#1a1a2e] py-12 md:py-20">
        <div className="container-page">
          {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-xs sm:text-sm text-gray-500 dark:text-white/60 mb-4 sm:mb-6">
            ...
            <span>/</span>
            <span className="text-gray-700 dark:text-white/80 line-clamp-1">{career.name}</span>
          </nav>
          ...
          <div className="flex flex-wrap gap-2.5 sm:gap-4">
            <div className="bg-white/80 dark:bg-white/10 backdrop-blur-sm rounded-full px-3.5 py-1.5 sm:px-5 sm:py-2 text-xs sm:text-sm text-gray-800 dark:text-white/90 font-medium">
